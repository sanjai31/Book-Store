...
<section class="bg-gray-50 dark:bg-gray-900">
  <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
      <a href="#" class="flex items-center mr-1 mb-3 text-2xl font-semibold text-gray-900 dark:text-white">
          <img class="w-[4rem] h-[4rem] mr-2" src="assets/images/logo/book_logo.png" alt="logo">
          BOOK STORE    
      </a>
      <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form class="space-y-4 md:space-y-6" method="POST" action="php/auth.php">
               
                  <?php if (isset($_GET['error'])) { ?>
                    <div class="border border-red-400 rounded-b bg-red-100 px-4 py-3 text-red-700" role="alert">
