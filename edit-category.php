...
<body class="bg-white dark:bg-slate-800 h-[900px]">
    ...
    <form action="php/edit-category.php" method="post" class="max-w-screen-xl mx-auto pt-24 item-center shadow-xl">
    <h1 class="mb-4 text-4xl leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white text-center">Edit Category</h1>
    <div class="p-10">
        ...
        <div class="relative z-0 w-full mb-6 group">
            <input type="text" name="category_name" value="<?=$category['name']?>" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" "/>
            ...
            <input type="text" name="category_id" value="<?=$category['id']?>" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " style="display: none !important;"/>
        </div>
